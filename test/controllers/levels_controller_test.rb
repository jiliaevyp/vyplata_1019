...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { action: @level.action, adminlevel: @level.adminlevel, controller: @level.controller, email: @level.email, params: @level.params, views: @level.views }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { action: @level.action, adminlevel: @level.adminlevel, controller: @level.controller, email: @level.email, params: @level.params, views: @level.views }
    assert_redirected_to level_path(assigns(:level))
  end
